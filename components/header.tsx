              ...
              <div className="flex flex-col p-6 space-y-4">
                ...
                {navItems.map((item) => (
                  <button
                    key={item.id}
                    onClick={() => handleNavClick(item.id)}
                    className={`text-left p-4 rounded-xl transition-all duration-300 border font-medium ${
                      activeSection === item.id
                        ? "text-white bg-blue-500/30 border-blue-400/50 shadow-lg"
                        : "text-white bg-white/10 hover:bg-white/20 border-white/30 hover:border-white/50"
                    }`}
                  >
                    {item.label}
                  </button>
                ...
                <div className="flex items-center gap-3 p-4 bg-white/15 rounded-xl border border-white/30">
